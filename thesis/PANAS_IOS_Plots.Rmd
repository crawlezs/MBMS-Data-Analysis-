...
pos_across_sessions <- pos_across_sessions + geom_line(aes( group=id), size=0.5, color="navy") + geom_line(aes(group=dummy), size=2, stat="summary", color="navy") + scale_x_continuous(breaks=seq(1, 7, 1), name="Session Number")+ ylab("PANAS Positive Affect Score")  +theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), text = element_text(size=20, face="bold"))
...
neg_across_sessions <- neg_across_sessions + geom_line(aes( group=id), size=0.5, color="navy") + geom_line(aes(group=dummy), size=2, stat="summary", color="navy") + scale_x_continuous(breaks=seq(1, 7, 1), name="Session Number")+ ylab("PANAS Negative Affect Score")  +theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), text = element_text(size=20, face="bold"))
...
ios_across_sessions <- ios_across_sessions + geom_line(aes( group=id), size=0.5, color="navy") + geom_line(aes(group=dummy), size=2, stat="summary", color="navy") + scale_x_continuous(breaks=seq(1, 7, 1), name="Session Number")+ ylab("IOS Score")  +theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), text = element_text(size=20, face="bold"))
